...
WAIT:
        LDR     R12, password   // value of current password stored in memory (#0b10011011), or new password if user modifies it (after input correct current password)
...
DELAY:                          
        ...
        BNE     CORRECT_PASSWORD // if KEY #3 not pressed, continue displaying LEDs of correct password
        BEQ     UPDATE_PASSWORD
